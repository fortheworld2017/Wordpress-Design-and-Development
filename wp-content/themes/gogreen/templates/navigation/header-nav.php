    ...
    <div class="container">       
        ...
        <nav id="top-nav" class="dropdown-nav">
            <ul class="top-menu">
                ...
                ?>    
                <li>
                	<a href="http://corevyo.finntheo.com/shop/" class="w-link-button rounded" style="background-color:#36C5F0;height: 35px; min-width: 50px;width:50px;max-width:50px; position: absolute;padding-left: 30px;padding-top:3px;">
                	<span class="w-button-text">BUY</span></a>
                </li>
            </ul>
