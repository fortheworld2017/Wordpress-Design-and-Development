...
<div class="portfolio-meta-widget widget">
    ...
    <p class="portfolio-external-link"><i class="gg-link"></i> <a href="<?php echo esc_url( $project_url );?>" title="Visit Site" class="launch-project"><?php echo esc_html__('Visit Site', 'gogreen');?></a></p>
    <?php endif; ?>
    <?php if( $post_date ): ?>
