<?php
    ...
    if( !empty($show_facepile) ) $attrs['data-show_facepile'] = $show_facepile;
    if( !empty($small_header) ) $attrs['data-small_header'] = $small_header;
    if( !empty($page_url) ) $attrs['data-page_url'] = esc_url( $page_url );
