...
if( !class_exists('GoGreen_MetaBox') ){
    ...
    class GoGreen_MetaBox{
        ...
        function __construct(){
            ...
            if ( is_admin() && ( $pagenow == 'post-new.php' || $pagenow == 'post.php' ) && class_exists('Wyde_MetaBox') ) {           
                ...
                foreach ($wyde_metabox->post_types as $post_type ) {               
                    if( $post_type ) add_filter( 'wyde_metabox_'.$post_type, array( $this, 'get_options_file'), 10 );
                }                
        ...
        public function load_metaboxes_scripts($hook) {             
            ...
            wp_enqueue_script( 'gogreen-metabox', get_template_directory_uri() .'/inc/metaboxes/js/options.js', null, null, true );
