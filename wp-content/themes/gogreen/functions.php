...
function gogreen_load_styles(){
    ...
    wp_enqueue_style('gogreen', get_stylesheet_uri(), null, $version);

    // Add main stylesheet
    wp_enqueue_style('gogreen-main', get_template_directory_uri() . '/css/main.css', array('gogreen'), $version);
    
    // Register font icons
    wp_enqueue_style('gogreen-icons', get_template_directory_uri() . '/css/icons.css', null, $version);

    // Shortcodes
    wp_enqueue_style('gogreen-shortcodes', get_template_directory_uri(). '/css/shortcodes.css', null, $version);    
...
function gogreen_load_scripts(){
    ...
    // jQuery plugins
    wp_enqueue_script('gogreen-plugins', get_template_directory_uri() . '/js/plugins.js', array('jquery'), $version, true);

    // Main scripts
    wp_enqueue_script('gogreen-main', get_template_directory_uri() . '/js/main.js', array('jquery'), $version, true);

    // Shortcodes scripts
    wp_enqueue_script('gogreen-shortcodes', get_template_directory_uri() . '/js/shortcodes.js', array('gogreen-main'), $version, true);
...
/* After switch theme */
function gogreen_after_switch_theme() {
    //flush rewrite rules after switch theme
    flush_rewrite_rules();
}
add_action('after_switch_theme', 'gogreen_after_switch_theme' );
