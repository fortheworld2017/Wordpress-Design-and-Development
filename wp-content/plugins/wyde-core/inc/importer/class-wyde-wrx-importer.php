...
require dirname( __FILE__ ) . '/class-wyde-logger-serversentevents.php';
require dirname( __FILE__ ) . '/class-wyde-wxr-import-info.php';


class Wyde_WXR_Importer extends WP_Importer {
	/**
