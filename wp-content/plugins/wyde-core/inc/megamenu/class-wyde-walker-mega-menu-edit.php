    ...
    class Wyde_Walker_MegaMenu_Edit extends Walker_Nav_Menu{
        ...
        */
        ...
        public function icon_picker_field( $item ){
            ...
            $icon = ($item->icon && $item->icon != 'none')? '<i class="'.$item->icon.'"></i>': esc_html__('None', 'wyde-core');             
        ...
        protected function get_icon_list(){
            ...
            if( ! $this->icon_picker_field_html ){
                ...
                $icons  = Wyde_Core::get_font_icons('fontawesome', '4.6.3', WYDE_PLUGIN_DIR . 'assets/css/font-awesome.min.css');
                ob_start();
                ?>                
                <ul>
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
                ...
                <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
                    ...
                    <?php endif; ?>
                    <?php /* Begin Wyde Menu Icon */ ?>      
                    <div class="w-field-icon description description-wide">
                        <?php $this->icon_picker_field($item); ?>
                    </div>
                    <?php /* End Wyde Menu Icon */ ?>
