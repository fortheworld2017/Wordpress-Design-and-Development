...
/* Half Donut Chart
---------------------------------------------------------- */
class WPBakeryShortCode_Wyde_Half_Donut_Chart extends WPBakeryShortCode {
}
...
vc_map( array(
    'name' => __('Half Donut Chart', 'wyde-core'),
    'description' => __('Animated half donut chart.', 'wyde-core'),
    'base' => 'wyde_half_donut_chart',
    'controls' => 'full',
    ...
    'params' => array(
            ...
            array(
                'param_name' => 'content',
                'type' => 'textarea_html',              
                'heading' => __('Description', 'wyde-core'),                
            ...
            array(
                ...
                'admin_label' => true,            
                'description' => __('Input chart value here. Choose range between 0 and 100.', 'wyde-core')
            ),
            array(
